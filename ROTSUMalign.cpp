...
"pairwise structure alignment by their rotamer sequence\n"
...
int main(int argc, char **argv)
{
    ...
    int seq_num1=read_pdb_as_rotseq(argv[1],name_list1,seq_list1,seq2int_list1);
    int seq_num2=read_pdb_as_rotseq(argv[2],name_list2,seq_list2,seq2int_list2);
    ...
    for (int q=0;q<seq_num1;q++)
    {
        ...
        for (int s=0;s<seq_num2;s++)
        {
            ...
            float aln_score=NWalign(seq1,seq2, seq2int1,seq2int2, aln1,aln2,
                ROTSUM8,gapopen_rotsum8,gapext_rotsum8);
